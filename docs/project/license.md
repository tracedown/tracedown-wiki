...
You can read the source, run it, modify it, self-host it, and redistribute it —
commercially or otherwise — under the license's terms.
...
along with its validator and executor implementations — is an independent
project, also licensed under **Apache License 2.0**. It is a specification
with independent implementations and a public conformance suite, so probes you
write are yours and are not locked to this platform.
